import svgPaths from "./svg-7pdi2eaj62";
...
function ViewedLevel2() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Viewed level">
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[26.25px] relative shrink-0 text-[21px] text-white" style={{ fontVariationSettings: "\'wdth\' 100" }}>
        Pepsi Max 0.33L
      </p>
    </div>
  );
...
function Information() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Information">
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[22.5px] relative shrink-0 text-[15px] text-white" style={{ fontVariationSettings: "\'wdth\' 100" }}>
        100001604
      </p>
    </div>
  );
